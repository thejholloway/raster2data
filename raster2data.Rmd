...
Store all the observations with NDVI value greater than 1 in a dataframe called 'data.final'.
...
Create a variable called class based on the ndvi.df dataframe, which gives land cover category based on NDVI cut off values.
